...
SECRET_KEY = 'django-insecure-x^tc@!7(zy8wqlsmycyk8bq==x83pc6ozoz82b7qei+bqwti#e'
...
INSTALLED_APPS = [
    ...
    "hw", # NEW
    "quotes", #Assignment1
    "formdata", #Assignment2prelecture
    "restaurant", #Assignment2
    "blog", #Assignment3prelecture
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            "string_if_invalid": "WARNING: {{%s}} noot a valid context variable.",
            'context_processors': [
...
if socket.gethostname() == CS_DEPLOYMENT_HOSTNAME:
    STATIC_URL = '/bmoges18/static/'
    MEDIA_URL = '/bmoges18/media/'
